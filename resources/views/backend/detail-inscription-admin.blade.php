            ...
            <tbody>
               ...
               @endphp
                ...
                <tr>
                    ...
                    <td>
                        <span class="alert alert-light " >
                            <a
                                href="{{ asset("storage/pdfs_documents/".$infos_souscription->piece_identite) }}" class="btn-link btn-visualiser-document" target="_blank" data-nom_document="Pièce d'identité" data-client="{{ $client_service->nom." ".$client_service->prenom }}">
                                <i class="fa fa-eye">&nbsp;</i>
                                Voir   
                            </a>
                        </span>
                    ...
                    <td>
                        <span class="alert alert-light " >
                            <a
                                href="{{ asset("storage/pdfs_documents/".$infos_souscription->attestation_diplome_plus_eleve) }}" class="btn-link btn-visualiser-document" target="_blank" data-nom_document="Diplôme le plus élevé" data-client="{{ $client_service->nom." ".$client_service->prenom }}">
                ...
                <tr>
                    ...
                    <td>
                            @php
                                $route_doc = $infos_souscription->releves_notes_diplome_plus_eleve ? asset("storage/pdfs_documents/".$infos_souscription->releves_notes_diplome_plus_eleve):"#";
                            @endphp

                            @if ($route_doc !="#")
                            <span class="alert alert-light " >
                                <a
                                    href="{{ $route_doc }}" target="_blank" data-nom_document="Relevé de notes" data-client="{{ $client_service->nom." ".$client_service->prenom }}" class="btn-link btn-visualiser-document">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <span class="alert alert-light " >
                            <a
                                href="{{ $route_doc }}" class="btn-link btn-visualiser-document" data-nom_document="Relevé de notes" data-client="{{ $client_service->nom." ".$client_service->prenom }}" target="_blank">
