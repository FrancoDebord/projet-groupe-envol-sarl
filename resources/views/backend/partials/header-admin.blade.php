            ...
            <div class="d-flex flex-wrap align-items-center gap-3">
                ...
                {{-- <div class="dropdown d-none d-sm-inline-block">
                    <button
                        ...
                        <img src="{{ asset("storage/assets_backend/images/lang-flag.png")}}" alt="image"
                        ...
                        <div class="max-h-400-px overflow-y-auto scroll-sm pe-8">
                            ...
                            <div
                                ...
                                <label class="form-check-label line-height-1 fw-medium text-secondary-light"
                                    ...
                                    <span
                                        class="text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3">
                                        <img src="{{ asset("storage/assets_backend/images/flags/flag5.png")}}" alt=""
                                            class="w-36-px h-36-px bg-success-subtle text-success-main rounded-circle flex-shrink-0">
                            ...
                            <div
                                ...
                                <label class="form-check-label line-height-1 fw-medium text-secondary-light"
                                    ...
                                    <span
                                        class="text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3">
                                        <img src="{{ asset("storage/assets_backend/images/flags/flag6.png")}}" alt=""
                                            class="w-36-px h-36-px bg-success-subtle text-success-main rounded-circle flex-shrink-0">
                            ...
                            <div
                                ...
                                <label class="form-check-label line-height-1 fw-medium text-secondary-light"
                                    ...
                                    <span
                                        class="text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3">
                                        <img src="{{ asset("storage/assets_backend/images/flags/flag7.png")}}" alt=""
                                            class="w-36-px h-36-px bg-success-subtle text-success-main rounded-circle flex-shrink-0">
                            ...
                            <div
                                ...
                                <label class="form-check-label line-height-1 fw-medium text-secondary-light"
                                    ...
                                    <span
                                        class="text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3">
                                        <img src="{{ asset("storage/assets_backend/images/flags/flag8.png")}}" alt=""
                                            class="w-36-px h-36-px bg-success-subtle text-success-main rounded-circle flex-shrink-0">
                        ...
                        <div class="max-h-400-px overflow-y-auto scroll-sm pe-4">
                            ...
                            <a href="javascript:void(0)"
                                ...
                                <div
                                    ...
                                    <span
                                        ...
                                        <img src="{{ asset("storage/assets_backend/images/notification/profile-3.png")}}" alt="">
                                        <span
                            ...
                            <a href="javascript:void(0)"
                                ...
                                <div
                                    ...
                                    <span
                                        class="w-40-px h-40-px rounded-circle flex-shrink-0 position-relative">
                                        <img src="{{ asset("storage/assets_backend/images/notification/profile-4.png")}}" alt="">
                                        <span
                            ...
                            <a href="javascript:void(0)"
                                ...
                                <div
                                    ...
                                    <span
                                        class="w-40-px h-40-px rounded-circle flex-shrink-0 position-relative">
                                        <img src="{{ asset("storage/assets_backend/images/notification/profile-5.png")}}" alt="">
                                        <span
                                            class="w-8-px h-8-px bg-success-main rounded-circle position-absolute end-0 bottom-0"></span>
                                    </span>
                                    <div>
                            ...
                            <a href="javascript:void(0)"
                                ...
                                <div
                                    ...
                                    <span
                                        class="w-40-px h-40-px rounded-circle flex-shrink-0 position-relative">
                                        <img src="{{ asset("storage/assets_backend/images/notification/profile-6.png")}}" alt="">
                                        <span
                                            class="w-8-px h-8-px bg-neutral-300 rounded-circle position-absolute end-0 bottom-0"></span>
                                    </span>
                                    <div>
                            ...
                            <a href="javascript:void(0)"
                                ...
                                <div
                                    ...
                                    <span
                                        class="w-40-px h-40-px rounded-circle flex-shrink-0 position-relative">
                                        <img src="{{ asset("storage/assets_backend/images/notification/profile-7.png")}}" alt="">
                                        <span
                                            class="w-8-px h-8-px bg-success-main rounded-circle position-absolute end-0 bottom-0"></span>
                                    </span>
                                    <div>
                        ...
                        <div class="max-h-400-px overflow-y-auto scroll-sm pe-4">
                            ...
                            <a href="javascript:void(0)"
                                ...
                                <div
                                    ...
                                    <span
                                        class="w-44-px h-44-px bg-success-subtle text-success-main rounded-circle d-flex justify-content-center align-items-center flex-shrink-0">
                                        <img src="{{ asset("storage/assets_backend/images/notification/profile-1.png")}}" alt="">
                                    </span>
                                    <div>
                            ...
                            <a href="javascript:void(0)"
                                ...
                                <div
                                    ...
                                    <span
                                        class="w-44-px h-44-px bg-success-subtle text-success-main rounded-circle d-flex justify-content-center align-items-center flex-shrink-0">
                                        <img src="{{ asset("storage/assets_backend/images/notification/profile-2.png")}}" alt="">
                                    </span>
                                    <div>
                ...
                <div class="dropdown">
                    <button class="d-flex justify-content-center align-items-center rounded-circle"
                        type="button" data-bs-toggle="dropdown">
                        <img src="{{ asset("storage/assets_backend/images/user.png")}}" alt="image"
