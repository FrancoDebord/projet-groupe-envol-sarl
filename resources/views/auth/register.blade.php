...
<!-- Mirrored from wowdash.wowtheme7.com/demo/sign-up.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 31 Aug 2024 12:13:00 GMT -->
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Groupe Envol Créer un compte</title>
    ...
    <div class="auth-right py-32 px-24 d-flex flex-column justify-content-center">
        <div class="max-w-464-px mx-auto w-100">
            <div>
                ...
                <h4 class="mb-12">Créer un compte</h4>
                <p class="mb-32 text-secondary-light text-lg">Bienvenue ! Renseignez vos informations</p>
            </div>
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="icon-field mb-16">
                    ...
                    <input type="text" class="form-control h-56-px bg-neutral-50 radius-12 @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Nom et prénom">
                ...
                <div class="icon-field mb-16">
                    ...
                    <input type="email" class="form-control h-56-px bg-neutral-50 radius-12 @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="Email">
                    @error('email')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="mb-20">
                    <div class="position-relative ">
                        <div class="icon-field">
                            ...
                            <input type="password" class="form-control h-56-px bg-neutral-50 radius-12 @error('password') is-invalid @enderror" id="your-password"  name="password" required autocomplete="new-password" placeholder="Créer un mot de passe">
                ...
                <div class="mb-20">
                    <div class="position-relative ">
                        <div class="icon-field">
                            ...
                            <input type="password" class="form-control h-56-px bg-neutral-50 radius-12 @error('password_confirmation') is-invalid @enderror" id="your-password"  name="password_confirmation" required autocomplete="new-password" placeholder="Confirmer le mot de passe">
                ...
                <button type="submit" class="btn btn-danger text-sm btn-sm px-12 py-16 w-100 radius-12 mt-32"> Créer le compte</button>
{{-- 
                ...
                <div class="mt-32 text-center text-sm">
                    <p class="mb-0">Vous avez déjà un compte ? <a href="{{ route("login") }}" class="text-primary-600 fw-semibold">Connectez-vous </a></p>
                </div>
