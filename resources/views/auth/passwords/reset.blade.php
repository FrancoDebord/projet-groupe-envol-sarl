            ...
            <div class="login-form">
                ...
                <form action="{{ route("password.update") }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" readonly value="{{ $email ?? old('email') }}" placeholder="Votre adresse Email">
                    ...
                    <div class="d-flex align-items-center">
                        <button type="submit" class="theme-btn">Valider pour changer le mot de passe<i class="far fa-key"></i></button>
                    </div>
                </form>
            </div>
        </div>
