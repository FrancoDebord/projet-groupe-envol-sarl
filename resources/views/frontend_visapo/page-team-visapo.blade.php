...
@section('title',"Groupe Envol Sarl --Notre Staff")
...
<div class="site-breadcrumb" style="background: url({{ asset("storage/assets_visapo/img/breadcrumb/breadcrumb.jpg") }})">
    <div class="container">
        <h2 class="breadcrumb-title">Notre Staff</h2>
        <ul class="breadcrumb-menu">
            <li><a href="{{ route("accueil") }}"><i class="far fa-home"></i> Home</a></li>
            <li class="active">Notre Staff</li>
        </ul>
    </div>
</div>
            ...
            <div class="col-md-6 col-lg-4 col-xl-4">
                <div class="team-item">
                    ...
                    <div class="team-content">
                        ...
                        <a class="team-social-btn" href="{{ route("afficherPageTeamMemberDetail",["id"=>$team_member->id,"slug"=>Str::slug($team_member->titre_member." ".$team_member->prenom_member." ".$team_member->nom_member)]) }}"><i class="far fa-share-alt"></i></a>
                    </div>
                </div>
            </div>
            @empty
