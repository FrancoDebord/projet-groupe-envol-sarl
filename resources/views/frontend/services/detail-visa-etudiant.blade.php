...
@section('title',"Detail sur  Visa Etudiant")
...
@section('page-title')
     ...
     <div class="auto-container">
         <div class="content-box p_relative pt_170 pb_170">
             <h1 class="d_block fs_40 lh_50 color_white fw_exbold color-white">Visa Etudiant</h1>
...
<div class="service-details-content">
    <div class="content-style-one">
        <figure class="image-box"><img src="{{ asset("storage/assets/services/visa_etudiant.jpg")}}" alt=""></figure>
        <div class="group-title">
            <h2>Visa Etudiant</h2>
        </div>
        <div class="text">
            <h3>Vous avez besoin d'un Visa Etudiant ?</h3>
            <p>
                VISA et carte de séjour. Le visa long séjour valant titre de séjour mention "étudiant", ou VLS-TS "étudiant", vous permet de suivre des études en France pour une période de quatre mois à un an. À son expiration, vous devez demander une carte de séjour pour pouvoir rester en France..</p>
        </div>
    </div>
