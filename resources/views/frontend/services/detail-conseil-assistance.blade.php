...
@section('title',"Detail sur Conseil et Assistance Voyage")
...
@section('page-title')
     ...
     <div class="auto-container">
         <div class="content-box p_relative pt_170 pb_170">
             <h1 class="d_block fs_40 lh_50 color_white fw_exbold color-white">Conseils et assistance Visa-voyage</h1>
...
<div class="service-details-content">
    <div class="content-style-one">
        <figure class="image-box"><img src="{{ asset("storage/assets/services/assistance_voyage.jpg")}}" alt=""></figure>
        <div class="group-title">
            <h2>Conseils et assistance Visa-voyage</h2>
        </div>
        <div class="text">
            <h3>Nous vous aidons à concrétiser vos projets de voyage..</h3>
            <p>Une assurance voyage est un contrat d'assurance. En échange d'un prix fixe, l'assureur s'engage à fournir à l'assuré un ensemble de garanties permettant d'être assisté et assuré avant, pendant et après son voyage..</p>
        </div>
    </div>
