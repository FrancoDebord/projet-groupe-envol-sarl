...
@section('title',"Detail sur Intermédiation de récrutement")
...
@section('page-title')
     ...
     <div class="auto-container">
         <div class="content-box p_relative pt_170 pb_170">
             <h1 class="d_block fs_40 lh_50 color_white fw_exbold color-white">Intermédiation de récrutement</h1>
...
<div class="service-details-content">
    <div class="content-style-one">
        <figure class="image-box"><img src="{{ asset("storage/assets/services/intermediation.jpg")}}" alt=""></figure>
        <div class="group-title">
            <h2>Intermédiation de récrutement</h2>
        </div>
        <div class="text">
            <h3>Vous rêvez de travailler à l'extérieur ? Nous avons des opportunités pour vous.</h3>
            <p>
                on entend par intermédiation toute opération ayant pour objet le rapprochement de l'offre et de la demande en matière d'emploi ainsi que tous services offerts aux demandeurs d'emploi et aux employeurs pour la promotion de l'emploi et l'insertion professionnelle</p>
        </div>
    </div>
