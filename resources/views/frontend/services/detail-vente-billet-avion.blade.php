...
@section('title',"Detail sur les Ventes de Billet d'avion")
...
@section('page-title')
     ...
     <div class="auto-container">
         <div class="content-box p_relative pt_170 pb_170">
             <h1 class="d_block fs_40 lh_50 color_white fw_exbold color-white">Ventes de Billet d'avion</h1>
...
<div class="service-details-content">
    <div class="content-style-one">
        <figure class="image-box"><img src="{{ asset("storage/assets/services/billet_avion.jpg")}}" alt=""></figure>
        <div class="group-title">
            <h2>Ventes de Billet d'avion</h2>
        </div>
        <div class="text">
            <h3>Nous faisons les courses pour vous alléger votre voyage. Nous pouvons vous vendre les billets d'avion et vous l'apporter chez vous en toute tranquillité..</h3>
            <p>
                Vous avez un programme de voyage. Laissez-nous vous faire les courses pour apprêter votre billet pour le vol.</p>
        </div>
    </div>
