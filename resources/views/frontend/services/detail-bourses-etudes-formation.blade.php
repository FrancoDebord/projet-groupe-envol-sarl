...
@section('title',"Detail sur les Bourses d'étude et de formation")
...
@section('page-title')
     ...
     <div class="auto-container">
         <div class="content-box p_relative pt_170 pb_170">
             <h1 class="d_block fs_40 lh_50 color_white fw_exbold color-white">Bourses d'étude et de formation</h1>
...
<div class="service-details-content">
    <div class="content-style-one">
        <figure class="image-box"><img src="{{ asset("storage/assets/services/education.jpg")}}" alt=""></figure>
        <div class="group-title">
            <h2>Bourses d'étude et de formation</h2>
        </div>
        <div class="text">
            <h3>Votre éducation est très importante pour nous. Nous cherchons des bourses d'étude et de formation pour vous.</h3>
            <p>
                Vous rêvez de poursuivre vos études dans un domaine prometteur. Nous pouvons vous aider à avoir des bourses d'étude et de formation.</p>
        </div>
    </div>
