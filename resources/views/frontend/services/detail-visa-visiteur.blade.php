...
@section('title',"Detail sur  Visa Visiteur")
...
@section('page-title')
     ...
     <div class="auto-container">
         <div class="content-box p_relative pt_170 pb_170">
             <h1 class="d_block fs_40 lh_50 color_white fw_exbold color-white">Visa Visiteur</h1>
...
<div class="service-details-content">
    <div class="content-style-one">
        <figure class="image-box"><img src="{{ asset("storage/assets/services/visa_visiteur.jpg")}}" alt=""></figure>
        <div class="group-title">
            <h2>Visa Visiteur</h2>
        </div>
        <div class="text">
            <h3>Vous avez besoin d'un Visa Visiteur ?</h3>
            <p>
                Un visa de visiteur (aussi appelé visa de résident temporaire) est un document officiel que les citoyens de pays visés par l'obligation de visa doivent obtenir pour pouvoir voyager et entrer au Canada à titre de visiteurs pendant une période d'au plus six mois. Nous apposons le visa dans votre passeport.</p>
        </div>
    </div>
