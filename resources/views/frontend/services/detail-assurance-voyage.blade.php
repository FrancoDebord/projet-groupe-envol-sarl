...
@section('title',"Detail sur  Assurance de voyage")
...
@section('page-title')
     ...
     <div class="auto-container">
         <div class="content-box p_relative pt_170 pb_170">
             <h1 class="d_block fs_40 lh_50 color_white fw_exbold color-white">Assurance de voyage</h1>
...
<div class="service-details-content">
    <div class="content-style-one">
        <figure class="image-box"><img src="{{ asset("storage/assets/services/assurance_voyage.jpg")}}" alt=""></figure>
        <div class="group-title">
            <h2>Assurance de voyage</h2>
        </div>
        <div class="text">
            <h3>Nous sommes dans l'assurance des voyage. Nous assurons vos arrières pour vous permettre de profiter à fond de vos voyage et d'atteindre pleinement vos obectifs</h3>
            <p>
                L'assurance voyage, c'est un ensemble de garanties et de services qui vous accompagnent avant (annulation de voyage), pendant (rapatriement médical, frais médicaux à l'étranger, retour anticipé...) et après votre voyage (aide-ménagère...).</p>
        </div>
    </div>
