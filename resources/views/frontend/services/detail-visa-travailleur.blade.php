...
@section('title',"Detail sur  Visa Travailleur")
...
@section('page-title')
     ...
     <div class="auto-container">
         <div class="content-box p_relative pt_170 pb_170">
             <h1 class="d_block fs_40 lh_50 color_white fw_exbold color-white">Visa Travailleur</h1>
...
<div class="service-details-content">
    <div class="content-style-one">
        <figure class="image-box"><img src="{{ asset("storage/assets/services/visa_travailleur.jpg")}}" alt=""></figure>
        <div class="group-title">
            <h2>Visa Travailleur</h2>
        </div>
        <div class="text">
            <h3>Vous avez besoin d'un Visa Travailleur ?</h3>
            <p>
                Il permet un séjour d'une année avec autorisation de travail, pour des jeunes étrangers âgés de 18 à 30 ans (35 ans pour l'Argentine, l'Australie et le Canada), dans le cadre d'accords bilatéraux négociés entre la France et leur pays.</p>
        </div>
    </div>
