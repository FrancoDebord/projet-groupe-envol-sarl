      ...
      <tr>
        ...
        <td class="container">
          <div class="content">
            ...
            <span class="preheader">Bonjour M/Mme. Merci de nous faire confiance.</span>
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main">

              <!-- START MAIN CONTENT AREA -->
              <tr>
                <td class="wrapper">
                  <p>Bonjour M/Mme {{ $nom." ".$prenom }}</p>
                  <p>Votre inscription a été bien prise en compte sur notre plateforme..</p>
